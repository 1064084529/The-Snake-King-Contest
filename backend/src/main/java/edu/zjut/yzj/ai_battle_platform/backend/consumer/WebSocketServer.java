package edu.zjut.yzj.ai_battle_platform.backend.consumer;

import com.alibaba.fastjson.JSONObject;
import edu.zjut.yzj.ai_battle_platform.backend.consumer.utils.Game;
import edu.zjut.yzj.ai_battle_platform.backend.consumer.utils.JwtAuthentication;
import edu.zjut.yzj.ai_battle_platform.backend.mapper.BotMapper;
import edu.zjut.yzj.ai_battle_platform.backend.mapper.RecordMapper;
...
public class WebSocketServer {
    ...
    /**
     * onMessage方法接收到move时间时调用的方法，其内部会判断是玩家亲自操作还是AI代码运行服务给出的操作。只有当玩家亲自出马的时候
